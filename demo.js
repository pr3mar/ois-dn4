// Janez Novak, 4da990b8-a066-4b39-8d7b-a026312da57b
// Tone Oblak, b5855ad0-7eae-4a8a-a762-70a333ec9fce
// Metka Polen, 76160f51-92d8-4541-ae16-84fd887c4e8e
...
function preberiMeritveVitalnihZnakov(tipForced, ehrIDForced, zdraviloForced) {
    console.log(tipForced, ehrIDForced, zdraviloForced);
    sessionId = getSessionId();
                        ...
                        success: function (res) {
                            ...
                            if (res) {
                                ...
                                for (var i in rows) {
                                    ...
                                    results += "<tr><td class='text-right'>" + datum + "," + cas + "</td><td class='text-right'>" + rows[i].temperatura.magnitude + " " + rows[i].temperatura.units + "</td>" +
                        ...
                        success: function (res) {
                            ...
                            if(res) {
                                ...
                                for (var i in rows) {
                                    ...
                                    results += "<tr onclick=\"preberiMeritveVitalnihZnakov('vse podatke','" + ehrId + "','" + rows[i].zdravilo.value + "')\"><td>" + rows[i].zdravilo.value + "</td><td  class='text-right'>" + datumStart + ", " + casStart + "</td><td  class='text-right'>" + datumEnd + ", " + casEnd + "</td></tr>";
                            }
                                results += "</table>";
                                $("#rezultatMeritveVitalnihZnakov").append(results);
                            } else {
